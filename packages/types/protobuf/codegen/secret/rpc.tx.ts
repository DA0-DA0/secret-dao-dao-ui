...
export const createRPCMsgClient = async ({
  ...
  secret: {
    compute: {
      v1beta1: new (await import("./compute/v1beta1/msg.rpc.msg")).MsgClientImpl(rpc)
    },
    emergencybutton: {
      v1beta1: new (await import("./emergencybutton/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    intertx: {
      v1beta1: new (await import("./intertx/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    }
  }
});