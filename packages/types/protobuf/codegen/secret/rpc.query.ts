...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    secret: {
      compute: {
        v1beta1: (await import("./compute/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      emergencybutton: {
        v1beta1: (await import("./emergencybutton/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      intertx: {
        v1beta1: (await import("./intertx/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      registration: {
        v1beta1: (await import("./registration/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};